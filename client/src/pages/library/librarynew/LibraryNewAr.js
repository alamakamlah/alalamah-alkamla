...
const LibraryNewAr = ({isEnglish, setIsEnglish}) => {
    ...
    if (profile.email !== "alalamahalkamla@gmail.com" || [profile]?.email !== "for4future@gmail.com") return null
