...
const LessonsAr = ({isEnglish, setIsEnglish}) => {
    ...
    const canAdd = user?.type?.english === "Teacher" || user?.type?.english === "Institution"
      ...
      <>
        ...
        <div className="forum-container">
            <div className="forum-heading" style={{flexDirection: "row-reverse", fontFamily: "var(--font-family-arabic)"}}>
                <h1 style={{fontFamily: "var(--font-family-arabic)"}}>الدروس</h1>
                <div className="forum-search lesson-search">
                    <form onSubmit={searchLesson} style={{textAlign: "end", fontFamily: "var(--font-family-arabic)"}}>
                        <input style={{textAlign: "end", fontFamily: "var(--font-family-arabic)"}} type="text" placeholder="البحث بالعنوان" value={search} onChange={(e) => setSearch(e.target.value)}   />
            ...
            {user && canAdd &&
                <h4 style={{textAlign: "end", flexDirection: "row-reverse", fontFamily: "var(--font-family-arabic)"}} className="store-link" onClick={() => {navigate('./new')}}>إضافة درس جديد</h4>                    
            }
