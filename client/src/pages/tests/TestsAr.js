...
const TestsAr = ({isEnglish, setIsEnglish}) => {
        ...
        <AdIconAr />
            <div className="store-container">
                <div className="store-heading" style={{flexDirection: "row-reverse", fontFamily: "var(--font-family-arabic)"}}>
                    <h1 style={{fontFamily: "var(--font-family-arabic)"}}>الاختبارات</h1>
                    <div className="store-search lesson-search">
                        <form onSubmit={searchProduct} style={{textAlign: "end", fontFamily: "var(--font-family-arabic)"}}>
                ...
                {user && canAdd &&
                    <h4 style={{textAlign: "end", flexDirection: "row-reverse", fontFamily: "var(--font-family-arabic)"}} className="store-link" onClick={() => {navigate('./new')}}>إضافة اختبار جديد</h4>                    
                }
